module.exports = {
    ...
    FORGOT_PASSWORD_TOKEN: process.env.FORGOT_PASSWORD_TOKEN || 'actionForgotPass',
    CREATE_ADMIN_ACTION_TOKEN: process.env.CREATE_ADMIN_ACTION_TOKEN || 'actionAdmin',
    ACCESS_ADMIN_TOKEN_SECRET: process.env.ACCESS_ADMIN_TOKEN_SECRET || 'admin',
    REFRESH_ADMIN_TOKEN_SECRET: process.env.REFRESH_ADMIN_TOKEN_SECRET || 'helloAdmin',
};
